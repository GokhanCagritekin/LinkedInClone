package com.trendyolbootcamp.linkedinclonejob.config;
...
@Configuration
public class ClientCouchbaseConfiguration {
    private final CouchbaseProperties couchbaseProperties;

    public ClientCouchbaseConfiguration(CouchbaseProperties couchbaseProperties) {
    ...
    @Bean
    public Collection jobCollection(Cluster couchbaseCluster) {
